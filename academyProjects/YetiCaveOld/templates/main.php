        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$valueLots['image_lot']; ?>" width="350" height="260" alt="фото">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$valueLots['title_lot']; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="templates/lot.php?id=<?=intval($valueLots['id_lots']); ?>"><?=$valueLots['title_lot']; ?></a></h3>
                    <div class="lot__state">
                        ...
                        <?=$valueLots['starting_price']; ?> // время до конца лота
                        </div>
                    </div>
                </div>
            </li>
